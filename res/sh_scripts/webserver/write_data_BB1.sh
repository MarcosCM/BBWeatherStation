#!/bin/bash
DATE=$(date +%T | sed 's/\([0-9]*\):\([0-9]*\):.*/\1:\2:00/')
#Measure temperature
echo $DATE $(cat /sys/bus/i2c/devices/i2c-1/1-0040/temp1_input) >> /www/pages/res/WC1/temperature.txt
...
#Measure pressure
echo $DATE $(cat /sys/bus/i2c/devices/i2c-1/1-0077/pressure_input) >> /www/pages/res/WC1/pressure.txt
...
#Measure humidity
echo $DATE $(cat /sys/bus/i2c/devices/i2c-1/1-0040/humidity1_input) >> /www/pages/res/WC1/humidity.txt
